...
$q1= "Select * from `overseas_offices` " . $order;
...
?>
    <div data-role="content">
  		<ul data-autodividers="true" data-role="listview" class="ui-listview" data-filter="true" data-theme="a">
    		...
    		?>
    		<li>
    			<h3 class="ui-li-heading" style="color:#2489ce;"><?php print $row['country']; ?></h3>
    			<p class="ui-li-desc"><?php print str_replace("\"", "", $row['Adress']); ?></p>
    			<p class="ui-li-desc"><img src="website.png" height="15" width="15"><?php print $row['E-mail']; ?>,<img src="phone white.png" height="15" width="15"> <?php print $row['Phone'];?>,<?php print $row['Jurisdiction']; ?> <?php print $row['Fax']; ?>
    		</li>
    		<?php } ?>
  		</ul>
		</div>
